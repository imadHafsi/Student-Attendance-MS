...
document.querySelectorAll('.edit-item-btn').forEach(function(button) {
    button.addEventListener('click', function() {
        ...
        var teacher_id = this.getAttribute('data-teacher_id');
        ...
        document.getElementById('teacher_id-field').value = teacher_id;
        ...
        document.getElementById('subjects-field').value = subject;
...
document.getElementById("showModal").addEventListener("hidden.bs.modal", function () {
    document.getElementById('id-field').value = "";
        document.getElementById('teacher_id-field').value = "";
        ...
        document.getElementById('subjects-field').value = "0";
...
if (e.relatedTarget.classList.contains("edit-item-btn")) {
    // Update scenario
    modalTitle.innerHTML = "Edit Teacher";
    ...
    form.teacher_id.value = e.relatedTarget.getAttribute("data-teacher_id");
    ...
    form.subjects.value = e.relatedTarget.getAttribute("data-subject");
